...
export const calcSubScore = (reviews, categoryCondition) => {
  ...
  // Math: 100 - ((NegComplaints / Total) * 100 * Multiplier)
  // We use a multiplier of 2.0 to make the score more sensitive to issues
  const deduction = (negativeComplaints.length / reviews.length) * 100 * 2.0;
