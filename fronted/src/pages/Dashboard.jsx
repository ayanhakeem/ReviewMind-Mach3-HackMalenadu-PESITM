...
export const Dashboard = () => {
  ...
  const filteredReviews = useMemo(() => {
    ...
    return currentAnalysis.processedReviews.filter(review => {
      ...
      // Sentiment check - handle cases where Gemini might return capitalized strings
      const reviewSentiment = (review.sentiment || '').toLowerCase().trim();
      const matchesSentiment = sentimentFilter === 'all' || reviewSentiment === sentimentFilter;
      
      // Language check
      const reviewLang = (review.language || '').toLowerCase().trim();
      const matchesLanguage = languageFilter === 'all' || reviewLang === languageFilter;
      ...
      <div className="hidden print:block bg-white min-h-screen text-slate-900 font-sans p-0 m-0 print-report">
        ...
        <section className="grid grid-cols-12 gap-8 mb-10 print-break-inside-avoid">
           ...
           <div className="col-span-8 grid grid-cols-2 gap-4">
              {[
                { label: 'Product Development', score: scores.productQuality, color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-100', icon: '✦' },
        ...
        <div className="lg:col-span-8 flex flex-col gap-12">
            ...
            <section className="flex flex-col md:flex-row gap-12 items-center apple-card p-8 relative overflow-hidden">
               ...
               <div className="flex-grow w-full flex flex-col gap-4 justify-center z-10">
                  ...
                  <MetricRow name="Product Development" score={scores.productQuality} trend={trends.productQuality} />
